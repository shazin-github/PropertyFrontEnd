	...
	<div id="page">
		...
		<header>
			...
			<nav>
				<ul>
					...
					<li class="listing"><a href="listing.html">Listing</a></li>
		...
		<footer>
			<div class="container">
							...
							<div class="footer-widget widget_most_viewed">
								...
								<div class="widget-body">
									<div class="most-viewed-property">
										...
										<h2><a href="single-full-width.html">Grand hotel</a></h2>
										<p class="price">$450</p>
										<ul class="rating">
									...
									<div class="most-viewed-property">
										...
										<h2><a href="single-full-width.html">Golden vip room</a></h2>
										<p class="price">$450</p>
										<ul class="rating">
											<li><i class="fa fa-star"></i></li>
											<li><i class="fa fa-star"></i></li>
							...
							<div class="footer-widget widget_contact">
								...
								<div class="widget-body">
									<ul class="contact-info">
										...
										<li class="mail">
											<p><a href="index.html#">Info@realtor.com</a></p>
										</li>
										<li class="location">
				...
				<div class="copyrigts">
					<p>Copyrights 2016. Designed by <a href="http://oxenlab.com/" target="blank">OxenLab</a></p>
				</div>
			</div>
		</footer>
	</div>
